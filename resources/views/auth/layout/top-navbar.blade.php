            ...
            <ul class="navbar-nav align-items-center">
                <li class="nav-item dropdown">
                    <a class="nav-link text-dark notification-bell unread dropdown-toggle"
                        ...
                        <svg class="text-gray-900 icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
                        ...
                        <div class="list-group list-group-flush">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0 ms-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h4 class="mb-0 h6 text-small">Jose Leos</h4>
                                            </div>
                                            <div class="text-end">
                                                <small class="text-danger">a few moments ago</small>
                                            </div>
                                        </div>
                                        <p class="mt-1 mb-0 font-small">Added you to an event "Project
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-bottom">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0 ms-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h4 class="mb-0 h6 text-small">Neil Sims</h4>
                                            </div>
                                            <div class="text-end">
                                                <small class="text-danger">2 hrs ago</small>
                                            </div>
                                        </div>
                                        <p class="mt-1 mb-0 font-small">You've been assigned a task for
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-bottom">
                                <div class="row align-items-center">
                                    ...
                                    <div class="m-2 col ps-0">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h4 class="mb-0 h6 text-small">Roberta Casas</h4>
                                            </div>
                                            <div class="text-end">
                                                <small>5 hrs ago</small>
                                            </div>
                                        </div>
                                        <p class="mt-1 mb-0 font-small">Tagged you in a document called
                                            "Financial plans",</p>
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action border-bottom">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0 ms-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h4 class="mb-0 h6 text-small">Joseph Garth</h4>
                                            </div>
                                            <div class="text-end">
                                                <small>1 d ago</small>
                                            </div>
                                        </div>
                                        <p class="mt-1 mb-0 font-small">New message: "Hey, what's up? All set
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-bottom">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0 ms-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h4 class="mb-0 h6 text-small">{{ Auth::user()->name }}</h4>
                                            </div>
                                            <div class="text-end">
                                                <small>2 hrs ago</small>
                                            </div>
                                        </div>
                                        <p class="mt-1 mb-0 font-small">New message: "We need to improve the
                                            UI/UX for the landing page."</p>
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="py-3 text-center dropdown-item fw-bold rounded-bottom">
                                <svg class="text-gray-400 icon icon-xxs me-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item dropdown ms-lg-3">
                    ...
                    <div class="py-1 mt-2 dropdown-menu dashboard-dropdown dropdown-menu-end">
                        ...
                        <a class="dropdown-item d-flex align-items-center"
                            href="{{ route('settings', Auth::user()->id) }}">
                            <svg class="text-gray-400 dropdown-icon me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
