        ...
        <div class="col-12 mb-4">
            <div class="card border-0 shadow components-section">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.update-user', ['encodedId' => base64_encode($user->id)]) }}"
                        class="row mb-4 mt-4" method="post">
                        @method('put')
                        @csrf
                        @if ($errors->any())
                            <div class="alert alert-danger">
                        ...
                        <div class="form-group mb-4 col-12 col-sm-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    placeholder="example@company.com" value="{{ old('email', $user->email) }}"
                        ...
                        <div class="form-group mb-4 col-12 col-sm-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror"
                                    placeholder="(john_doe) or Anything u want" id="username"
                        ...
                        <div class="form-group mb-4 col-12 col-sm-4">
                            ...
                            <div class="input-group">
                                ...
                                <input data-datepicker="" name="birthday" class="form-control" value="{{ $user->birthday }}"
                                    id="birthday" type="text" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-4 col-12 col-sm-4">
                            ...
                            <select class="form-select mb-0" name="roles[]" id="roles" aria-label="Select roles"
                                multiple>
