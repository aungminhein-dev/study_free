    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">Create a Role</h2>
                @if ($errors->any())
                ...
                <form action="{{ route('manage-roles.store') }}" method="post">
                    ...
                    <div class="card card-body shadow border-0 table-wrapper table-responsive">
                        <table class="table user-table table-hover align-items-center">
                            ...
                            <tbody>
                                @foreach ($permissions as $entity => $features)
                                    <tr>
                                        <td>
                                            <span>{{ ucfirst($entity) }}</span>
                                        </td>
                                        <td>
                                            <div class="form-check dashboard-check">
                                                <input class="form-check-input" type="checkbox" name="permissions[]" value="view {{ $entity }}" id="view-{{ $entity }}">
                                                <label class="form-check-label" for="view-{{ $entity }}"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check dashboard-check">
                                                <input class="form-check-input" type="checkbox" name="permissions[]" value="create {{ $entity }}" id="create-{{ $entity }}">
                                                <label class="form-check-label" for="create-{{ $entity }}"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check dashboard-check">
                                                <input class="form-check-input" type="checkbox" name="permissions[]" value="update {{ $entity }}" id="update-{{ $entity }}">
                                                <label class="form-check-label" for="update-{{ $entity }}"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check dashboard-check">
                                                <input class="form-check-input" type="checkbox" name="permissions[]" value="delete {{ $entity }}" id="delete-{{ $entity }}">
                                                <label class="form-check-label" for="delete-{{ $entity }}"></label>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
