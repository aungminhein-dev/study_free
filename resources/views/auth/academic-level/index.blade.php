        ...
        <div>
            <div class="dropdown">
                <a href="{{ route('academic-levels.create') }}"
                    class="btn btn-secondary d-inline-flex align-items-center me-2 " aria-expanded="false">
                ...
                <tr>
                    @foreach ($levels as $level)
                        ...
                        <td><a href="#" class="d-flex align-items-center">
                                <div class="d-block"><span class="fw-bold">{{ $level->academic_level }}</span>
                                </div>
                            </a>
                        </td>

                        <td>
                            {{ $level->educationType->name }}
                        </td>
                        <td>
                            <span class="text-muted">{{ $level->created_at->format('j-F-Y') }}</span>
                        </td>
                        <td>
                            <div class="btn-group"><button
                                ...
                                <div class="py-1 mt-2 dropdown-menu dashboard-dropdown dropdown-menu-start">
                                    <a class="dropdown-item d-flex align-items-center" href=""><svg
                                        ...
                                        href="{{ route('academic-levels.edit', $level->id) }}"><svg
                                            class="text-gray-400 dropdown-icon me-2" fill="currentColor"
                                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        href="{{ route('academic-levels.destroy', $level->id) }}"><svg
                            ...
                            <form action="{{ route('academic-levels.destroy', $level->id) }}" method="POST"
