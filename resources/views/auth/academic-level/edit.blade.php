    ...
    <div class="py-4">
        ...
        <div class="flex-wrap d-flex justify-content-between w-100">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Edit Academic Level</h1>
                <p class="mb-0">Edit more Academic Level with multiple to get more dynamics!
                </p>
            </div>
            <div>
                        ...
                        <div class="mb-4 form-group col-12 col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('levelName') is-invalid @enderror"
                                    ...
                                    value="{{ old('levelName', $data->academic_level) }}" name="levelName">
                            </div>
                            @error('levelName')
                        ...
                        <div class="mb-4 form-group col-12 col-sm-4">
                            ...
                            <select class="mb-0 form-select" name="typeId" id="">
                                ...
                                @foreach ($educationTypes as $type)
                                    <option value="{{ $type->id }}" @selected($type->id == $data->education_type_id)>{{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
