                ...
                <div class="col-9 col-lg-8 d-md-flex">
                    <div class="input-group me-2 me-lg-3 fmxw-300"><span class="input-group-text"><svg
                                ...
                                <path fill-rule="evenodd"
                                    d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
                                    clip-rule="evenodd"></path>
                            </svg> </span><input type="text" class="form-control" placeholder="Search users">
                    </div><select class="form-select fmxw-200 d-none d-md-inline"
            ...
            <table class="table user-table table-hover align-items-center">
                ...
                <tbody>
                        ...
                        <td>
                            <div class="btn-group"><button
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1"><a
                                        ...
                                        href="#"><svg class="dropdown-icon text-danger me-2"
                                            fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check"><input class="form-check-input" type="checkbox"
                                    value id="userCheck2"> <label class="form-check-label" for="userCheck2"></label>
                            </div>
                        </td>
                        <td><a href="#" class="d-flex align-items-center">
                                ...
                                <div class="d-block"><span class="fw-bold">Scott Anderson</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="e68f888089a6839e878b968a83c885898b">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
                        <td><span class="fw-normal">10 Feb 2020</span></td>
                    ...
                    <tr>
                        ...
                        <td><a href="#" class="d-flex align-items-center"><img
                                ...
                                <div class="d-block"><span class="fw-bold">George Driskell</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="eb82858d84ab8e938a869b878ec5888486">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
                        <td><span class="fw-normal">10 Feb 2020</span></td>
                    ...
                    <tr>
                        ...
                        <td><a href="#" class="d-flex align-items-center"><img
                                ...
                                <div class="d-block"><span class="fw-bold">Bonnie Green</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="85ecebe3eac5e0fde4e8f5e9e0abe6eae8">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
                        <td><span class="fw-normal">10 Feb 2020</span></td>
                        ...
                        <td>
                            ...
                            </div><svg class="icon icon-xs text-danger ms-1" title="Delete"
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check"><input class="form-check-input"
                                    type="checkbox" value id="userCheck5"> <label class="form-check-label"
                        ...
                        <td><a href="#" class="d-flex align-items-center"><img
                                ...
                                <div class="d-block"><span class="fw-bold">Ronnie Buchanan</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="cca5a2aaa38ca9b4ada1bca0a9e2afa3a1">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
                        <td><span class="fw-normal">10 Feb 2020</span></td>
                        <td><span class="fw-normal d-flex align-items-center"><svg
                                    class="icon icon-xxs text-purple me-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check"><input class="form-check-input"
                                    type="checkbox" value id="userCheck6"> <label class="form-check-label"
                        ...
                        <td><a href="#" class="d-flex align-items-center">
                                ...
                                <div class="d-block"><span class="fw-bold">Jane Rinehart</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="a5cccbc3cae5c0ddc4c8d5c9c08bc6cac8">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
                        <td><span class="fw-normal">10 Feb 2020</span></td>
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check"><input class="form-check-input"
                                    type="checkbox" value id="userCheck7"> <label class="form-check-label"
                        ...
                        <td><a href="#" class="d-flex align-items-center"><img
                                ...
                                <div class="d-block"><span class="fw-bold">William Ginther</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="9df4f3fbf2ddf8e5fcf0edf1f8b3fef2f0">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
                        <td><span class="fw-normal">10 Feb 2020</span></td>
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check"><input class="form-check-input"
                                    type="checkbox" value id="userCheck8"> <label class="form-check-label"
                        ...
                        <td><a href="#" class="d-flex align-items-center"><img
                                ...
                                <div class="d-block"><span class="fw-bold">Margaret Dow</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="93fafdf5fcd3f6ebf2fee3fff6bdf0fcfe">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
                        <td><span class="fw-normal">10 Feb 2020</span></td>
                    ...
                    <tr>
                        <td class="border-0">
                            <div class="form-check dashboard-check"><input class="form-check-input"
                                    type="checkbox" value id="userCheck9"> <label class="form-check-label"
                        ...
                        <td class="border-0"><a href="#" class="d-flex align-items-center">
                                ...
                                <div class="d-block"><span class="fw-bold">Michael Hopkins</span>
                                    <div class="small text-gray"><span class="__cf_email__"
                                            data-cfemail="076e69616847627f666a776b622964686a">[email&#160;protected]</span>
                                    </div>
                                </div>
                            </a></td>
