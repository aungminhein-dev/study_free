    ...
    <section class="mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            ...
            <div class="row justify-content-center form-bg-image"
                data-background-lg="{{ asset('admin_ui/assets/img/illustrations/signin.svg') }}">
                        ...
                        <form action="{{ route('register') }}" class="mt-4" method="post">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email"  class="form-control @error('email') is-invalid @enderror"
                                        placeholder="example@company.com" value="{{ old('email') }}" name="email" id="email" autofocus>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" oninput="generateUsername()"  class="form-control @error('name') is-invalid @enderror"
                                        placeholder="John Doe" value="{{ old('name') }}" name="name" id="name" autofocus>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"  class="form-control @error('username') is-invalid @enderror"
                                        placeholder="(john_doe) or Anything u want" id="username" value="{{ old('username') }}" name="username">
